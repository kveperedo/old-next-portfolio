...
const IndexPage = () => {
	...
	return (
		<div>
			<Head>
				<title>Portfolio | Kevin Von Erich Peredo</title>
				<link rel="icon" href="/images/logo.svg" />
				<meta name="description" content="A full-time software engineer working at Lexagle Inc. in the Philippines."></meta>
			</Head>
